...
lazy_static! {
    static ref DEFAULT_CLIENT_CONFIG: ConfigInner = toml::from_str(include_str!(concat!(
...
pub type ClientConfig = Arc<ConfigStore<ConfigInner>>;
pub fn client_config(path: PathBuf) -> Result<ClientConfig> {
